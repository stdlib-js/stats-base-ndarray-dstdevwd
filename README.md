...
```bash
npm install @stdlib/stats-base-ndarray-dstdevwd
```
...
```javascript
var dstdevwd = require( '@stdlib/stats-base-ndarray-dstdevwd' );
```
...
```c
#include "stdlib/stats/base/ndarray/dstdevwd.h"
```

#### stdlib_stats_dstdevwd( arrays )
...
double v = stdlib_stats_dstdevwd( arrays );
// returns ~2.0817
...
```c
double stdlib_stats_dstdevwd( const struct ndarray *arrays[] );
```
